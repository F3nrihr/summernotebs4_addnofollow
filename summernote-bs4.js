...
var LinkDialog = /** @class */ (function () {
    ...
    LinkDialog.prototype.initialize = function () {
        ...
        var body = [
            ...
            !this.options.disableLinkTarget
                ? $$1('<div/>').append(this.ui.checkbox({
                    id: 'sn-checkbox-add-no-follow',
                    text: this.lang.link.addNoFollow,
                    checked: true
                }).render()).html()
                : ''
        ].join('');
    ...
    LinkDialog.prototype.showLinkDialog = function (linkInfo) {
        ...
        return $$1.Deferred(function (deferred) {
            ...
            var $openInNewWindow = _this.$dialog.find('input[type=checkbox]#sn-checkbox-open-in-new-window');
            var $addNoFollow = _this.$dialog.find('input[type=checkbox]#sn-checkbox-add-no-follow');
            ...
            _this.ui.onDialogShown(_this.$dialog, function () {
                ...
                var isChecked = linkInfo.isNoFollow !== undefined
                    ? linkInfo.isNoFollow : _this.context.options.linkNoFollow;
                $addNoFollow.prop('checked', isChecked);
                $linkBtn.one('click', function (event) {
                    ...
                    deferred.resolve({
                        ...
                        isNoFollow: $addNoFollow.is(':checked')
                    });
